...
export const DOM_IDS = Object.freeze({
  ...
  // ── Créditos ────────────────────────────────────────────────────
  VIEW_CREDITOS:         'view-creditos',
  VIEW_ACREEDOR_FORM:    'view-acreedor-form',
  VIEW_CREDITO_FORM:     'view-credito-form',
  VIEW_CREDITO_DETAIL:   'view-credito-detail',
  VIEW_PAGO_CREDITO_FORM:'view-pago-credito-form',
  CREDITOS_CONTENT:      'creditos-content',
  CREDITOS_METRICS:      'creditos-metrics',
  CREDITOS_SEARCH:       'creditos-search',
  BTN_NUEVO_CREDITO:     'btn-nuevo-credito',
  BTN_NUEVO_ACREEDOR:    'btn-nuevo-acreedor',
  CREDITO_DETAIL_CONTENT:'credito-detail-content',
  // Formulario acreedor
  ACREEDOR_FORM:           'acreedor-form',
  ...
  ACREEDOR_NOTAS:          'acreedor-notas',
  ACREEDOR_FORM_ERROR:     'acreedor-form-error',
  BTN_SUBMIT_ACREEDOR:     'btn-submit-acreedor',
  BTN_CANCEL_ACREEDOR:     'btn-cancel-acreedor',
  // Formulario crédito
  CREDITO_FORM:            'credito-form',
  CREDITO_ACREEDOR_ID:     'credito-acreedor-id',
  CREDITO_MONTO:           'credito-monto',
  CREDITO_TASA:            'credito-tasa',
  CREDITO_TIPO:            'credito-tipo',
  CREDITO_FRECUENCIA:      'credito-frecuencia',
  CREDITO_FECHA:           'credito-fecha',
  CREDITO_FECHA_PP:        'credito-fecha-primer-pago',
  CREDITO_NUM_CUOTAS:      'credito-num-cuotas',
  CREDITO_NOTAS:           'credito-notas',
  CREDITO_RESUMEN:         'credito-resumen',
  CREDITO_FORM_ERROR:      'credito-form-error',
  BTN_SUBMIT_CREDITO:      'btn-submit-credito',
  BTN_CANCEL_CREDITO:      'btn-cancel-credito',
  // Formulario pago de crédito
  PAGO_CREDITO_FORM:       'pago-credito-form',
  PAGO_CREDITO_MONTO:      'pago-credito-monto',
  PAGO_CREDITO_FECHA:      'pago-credito-fecha',
  PAGO_CREDITO_METODO:     'pago-credito-metodo',
  PAGO_CREDITO_CUOTA_ID:   'pago-credito-cuota-id',
  PAGO_CREDITO_NOTAS:      'pago-credito-notas',
  PAGO_CREDITO_FORM_ERROR: 'pago-credito-form-error',
  BTN_SUBMIT_PAGO_CREDITO: 'btn-submit-pago-credito',
  BTN_CANCEL_PAGO_CREDITO: 'btn-cancel-pago-credito',
})
