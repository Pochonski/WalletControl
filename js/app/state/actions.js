...
export const ACTION_TYPES = Object.freeze({
  ...
  // ── Créditos (pasivo: préstamos recibidos por el prestamista) ─────────────
  LOAD_ACREEDORES:      'ACREEDORES/LOAD',
  ADD_ACREEDOR:         'ACREEDORES/ADD',
  UPDATE_ACREEDOR:      'ACREEDORES/UPDATE',

  LOAD_CREDITOS:        'CREDITOS/LOAD',
  ADD_CREDITO:          'CREDITOS/ADD',
  UPDATE_CREDITO:       'CREDITOS/UPDATE',
  ARCHIVE_CREDITO:      'CREDITOS/ARCHIVE',
  SET_SELECTED_CREDITO: 'CREDITOS/SET_SELECTED',

  LOAD_CUOTAS_CREDITO:  'CUOTAS_CREDITO/LOAD',
  UPDATE_CUOTA_CREDITO: 'CUOTAS_CREDITO/UPDATE',

  LOAD_PAGOS_CREDITO:   'PAGOS_CREDITO/LOAD',
  ADD_PAGO_CREDITO:     'PAGOS_CREDITO/ADD',
