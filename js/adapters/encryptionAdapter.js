...
export const encryptionAdapter = {
  ...
  async encryptClientData(cliente) {
    try {
      ...
      // Nota: Fotos se manejan en fileAdapters, no aquí
      // Solo guardamos las rutas, las fotos van a Storage
    ...
    try {
      ...
      if (clienteEncriptado.cedula) {
        try {
          ...
          // Si falla la desencriptación, mantener el valor encriptado
          // y marcar como no disponible
